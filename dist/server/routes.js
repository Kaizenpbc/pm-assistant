...
const systemHealth_1 = require("./routes/systemHealth");
const performanceMonitoring_1 = require("./routes/performanceMonitoring");
async function registerRoutes(fastify) {
    ...
    await fastify.register(performanceMonitoring_1.performanceMonitoringRoutes, { prefix: '/api/v1' });
    await fastify.register(systemHealth_1.systemHealthRoutes);
