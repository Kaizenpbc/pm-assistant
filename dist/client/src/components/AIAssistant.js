...
const AIAssistant = ({ onClose, type, projectId, projectName }) => {
    ...
    const [isChatStarted, setIsChatStarted] = (0, react_1.useState)(false);
...
**What would you like to know about this project?**`,
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4", children: (0, jsx_runtime_1.jsxs)("div", { className: "bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between p-6 border-b", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "text-lg font-semibold text-gray-900", children: getTitle() }), (0, jsx_runtime_1.jsx)("p", { className: "text-sm text-gray-500", children: getDescription() })] }), (0, jsx_runtime_1.jsx)("button", { onClick: onClose, className: "text-gray-400 hover:text-gray-600 transition-colors", children: (0, jsx_runtime_1.jsx)("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0, jsx_runtime_1.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })] }), type === 'chat' ? ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col h-[70vh]", children: [(0, jsx_runtime_1.jsx)("div", { className: "flex-1 overflow-y-auto p-6 space-y-4", children: !isChatStarted ? ((0, jsx_runtime_1.jsxs)("div", { className: "text-center py-8", children: [(0, jsx_runtime_1.jsx)("div", { className: "w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4", children: (0, jsx_runtime_1.jsx)("span", { className: "text-blue-600 text-2xl", children: "\uD83D\uDCAC" }) }), (0, jsx_runtime_1.jsx)("h4", { className: "text-lg font-medium text-gray-900 mb-2", children: "Ready to chat!" }), (0, jsx_runtime_1.jsx)("p", { className: "text-gray-500 mb-6", children: "Start a conversation with your AI project management assistant" }), (0, jsx_runtime_1.jsx)("button", { onClick: startChat, className: "btn btn-primary", children: "Start Chat" })] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [chatMessages.map((message) => ((0, jsx_runtime_1.jsx)("div", { className: `flex ${message.type === 'user' ? 'justify-end' : 'justify-start'}`, children: (0, jsx_runtime_1.jsxs)("div", { className: `max-w-[80%] rounded-lg p-4 ${message.type === 'user'
                                                ? 'bg-blue-600 text-white'
                                                : 'bg-gray-100 text-gray-900'}`, children: [(0, jsx_runtime_1.jsx)("div", { className: "whitespace-pre-wrap text-sm", children: message.content }), (0, jsx_runtime_1.jsx)("div", { className: `text-xs mt-2 ${message.type === 'user' ? 'text-blue-100' : 'text-gray-500'}`, children: message.timestamp.toLocaleTimeString() })] }) }, message.id))), isLoading && ((0, jsx_runtime_1.jsx)("div", { className: "flex justify-start", children: (0, jsx_runtime_1.jsx)("div", { className: "bg-gray-100 rounded-lg p-4", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center space-x-2", children: [(0, jsx_runtime_1.jsx)("div", { className: "animate-spin rounded-full h-4 w-4 border-b-2 border-blue-600" }), (0, jsx_runtime_1.jsx)("span", { className: "text-sm text-gray-600", children: "AI is thinking..." })] }) }) })), (0, jsx_runtime_1.jsx)("div", { ref: messagesEndRef })] })) }), isChatStarted && ((0, jsx_runtime_1.jsxs)("div", { className: "border-t p-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex space-x-3", children: [(0, jsx_runtime_1.jsx)("input", { type: "text", value: userInput, onChange: (e) => setUserInput(e.target.value), onKeyPress: (e) => e.key === 'Enter' && handleSendMessage(), placeholder: "Ask me about your projects...", className: "flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500", disabled: isLoading }), (0, jsx_runtime_1.jsx)("button", { onClick: handleSendMessage, disabled: !userInput.trim() || isLoading, className: "px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed", children: "Send" })] }), (0, jsx_runtime_1.jsx)("div", { className: "mt-2 text-xs text-gray-500", children: "\uD83D\uDCA1 Try asking: \"How are my projects performing?\" or \"What risks should I watch out for?\"" })] }))] })) : ((0, jsx_runtime_1.jsxs)("div", { className: "p-6", children: [!response && !isLoading && ((0, jsx_runtime_1.jsxs)("div", { className: "text-center py-8", children: [(0, jsx_runtime_1.jsx)("div", { className: "w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4", children: (0, jsx_runtime_1.jsx)("span", { className: "text-blue-600 text-2xl", children: type === 'analysis' ? '🤖' : type === 'recommendations' ? '💡' : '💬' }) }), (0, jsx_runtime_1.jsx)("h4", { className: "text-lg font-medium text-gray-900 mb-2", children: "Ready to help!" }), (0, jsx_runtime_1.jsxs)("p", { className: "text-gray-500 mb-6", children: [type === 'analysis' && "Click below to analyze your project performance", type === 'recommendations' && "Click below to get smart recommendations", type === 'chat' && "Click below to start chatting with your AI assistant"] }), (0, jsx_runtime_1.jsxs)("button", { onClick: handleAIRequest, className: "btn btn-primary", children: [type === 'analysis' && "Analyze Projects", type === 'recommendations' && "Get Recommendations", type === 'chat' && "Start Chat"] })] })), isLoading && ((0, jsx_runtime_1.jsxs)("div", { className: "text-center py-8", children: [(0, jsx_runtime_1.jsx)("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4" }), (0, jsx_runtime_1.jsx)("p", { className: "text-gray-600", children: "AI is thinking..." })] })), response && ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-4", children: [(0, jsx_runtime_1.jsx)("div", { className: "bg-gray-50 rounded-lg p-4", children: (0, jsx_runtime_1.jsx)("pre", { className: "whitespace-pre-wrap text-sm text-gray-700 font-mono", children: response }) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex space-x-3", children: [(0, jsx_runtime_1.jsx)("button", { onClick: handleAIRequest, className: "btn btn-secondary", children: "Try Again" }), (0, jsx_runtime_1.jsx)("button", { onClick: onClose, className: "btn btn-primary", children: "Close" })] })] }))] }))] }) }));
};
