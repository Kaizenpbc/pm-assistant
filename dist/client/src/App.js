...
const MonitoringPage_1 = __importDefault(require("./pages/MonitoringPage"));
const PerformanceDashboard_1 = __importDefault(require("./components/PerformanceDashboard"));
