...
export class AIReportService {
  ...
  async generateReport(
    ...
    if (options.projectId) {
      ...
      try {
        const ctx = await this.contextBuilder.buildPortfolioContext(options.regionId);
    ...
    if (!claudeService.isAvailable()) {
      ...
      const report: GeneratedReport = {
        ...
        generatedAt,
        aiPowered: false,
        metadata: { projectId: options.projectId, regionId: options.regionId },
      };
    ...
    try {
      ...
      logAIUsage(this.fastify, {
        ...
        success: true,
        requestContext: { reportType, projectId: options.projectId, regionId: options.regionId },
      });
