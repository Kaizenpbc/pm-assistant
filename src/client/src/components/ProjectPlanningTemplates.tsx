...
const ProjectPlanningTemplates: React.FC<ProjectPlanningTemplatesProps> = ({
  ...
  // Guyana-Style Project Templates
  ...
  const handleTemplateSelect = (template: ProjectTemplate) => {
    ...
    // Start with no phases selected - let user choose what they want
    setSelectedPhases([]);
    // Start with no documents selected - let user choose what they want
  ...
  const handleGenerateProject = () => {
    ...
    if (selectedTemplate) {
      const templateData = {
        ...selectedTemplate,
        selectedPhases: selectedPhases, // Keep as array of IDs
        selectedDocuments: selectedDocuments // Keep as array of IDs
      };
          ...
          {templates.map((template) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg hover:border-blue-300 cursor-pointer transition-all duration-200"
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 font-medium">{template.category}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center text-sm text-gray-500">
                  ...
                  {template.documents.length} Required Documents
                </div>
              </div>
            );
          })}
    ...
    <div className="w-full">
        ...
        <div className="flex items-center mb-4">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-blue-600 font-medium">{selectedTemplate.category}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-gray-600 mb-6">Select the phases you want to include in your project:</p>
              ...
              <div key={phase.id} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <label htmlFor={phase.id} className="font-medium text-gray-900 cursor-pointer">
                      {phase.name}
                    </label>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-gray-600 mb-6">Select the documents you need for this project:</p>
          ...
          <div className="space-y-3">
            {selectedTemplate.documents.map((doc) => (
              <div key={doc.id} className="flex items-start gap-3 p-3 border border-gray-200 rounded-lg">
                ...
                />
                <div className="flex-1">
                  <label htmlFor={doc.id} className="font-medium text-gray-900 cursor-pointer flex items-center gap-2">
                    {doc.name}
                    {doc.required && (
      ...
      <div className="mt-8 flex justify-end gap-3">
        ...
        <div className="mt-2 p-2 bg-gray-100 text-xs text-gray-600 rounded">
          Debug: selectedPhases={JSON.stringify(selectedPhases)} ({selectedPhases.length} selected), 
          selectedDocuments={JSON.stringify(selectedDocuments)} ({selectedDocuments.length} selected)
        </div>
      </div>
    </div>
  );
