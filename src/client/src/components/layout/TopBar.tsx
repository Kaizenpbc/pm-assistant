...
import { Search, Bell, ChevronRight, LogOut, User, Shield } from 'lucide-react';
...
function buildBreadcrumbs(pathname: string): Breadcrumb[] {
  ...
  for (const segment of segments) {
    ...
    const label =
      ...
      (segment.length <= 6 ? segment.toUpperCase() : segment.charAt(0).toUpperCase() + segment.slice(1));
...
const TopBar: React.FC<TopBarProps> = ({ unreadCount = 0 }) => {
