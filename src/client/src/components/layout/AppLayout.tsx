...
const SIDEBAR_STORAGE_KEY = 'pm-sidebar-collapsed';
const AI_PANEL_STORAGE_KEY = 'pm-ai-panel-open';

/**
 * Reads a boolean from localStorage, returning the default if not found or invalid.
 */
...
/**
 * Custom hook to track window width and responsive breakpoints.
...
const AppLayout: React.FC<AppLayoutProps> = ({ children }) => {
  ...
  // Determine what is visible at current breakpoint
  ...
  // Calculate main content margin based on visible panels
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Wrapper: shifts for sidebar and AI panel */}
      <div
            ...
            <>
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-xs text-gray-500 max-w-[240px] leading-relaxed">
                  ...
                  task breakdowns. The full AI chat experience is coming soon.
                </p>
              </div>
      ...
      {/* Floating AI Toggle (when panel is closed on desktop, or on tablet) */}
