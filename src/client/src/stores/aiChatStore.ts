...
export const useAIChatStore = create<AIChatState>()((set, get) => ({
  ...
  sendMessage: async (userMessage, context) => {
    ...
    // Get the ID of the placeholder message
...
export const projectQuickActions: QuickAction[] = [
  ...
  { id: 'weather', label: 'Weather Impact', icon: 'Cloud', prompt: 'Are there any weather risks that could affect this project\'s outdoor tasks?' },
];
